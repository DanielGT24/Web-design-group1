...
<div style="display:inline-block;vertical-align:top;">
    <img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" width="105" height="80"/> 
</div>
    <div style="display:inline-block;">
<div class="header">
  <h1 style = "font-family: 'Courier New', Courier, monospace; font-size: 30px;"> Formula 1 Crypto.com Miami Grand Prix 2022 </h1>

</div>
</div>
      
            <img style= "float: right;" src="https://d3cm515ijfiu6w.cloudfront.net/wp-content/uploads/2022/05/05073857/miami-grand-prix-circuit-dusk-2022-planetf1.jpg"
           width="500" height="350"/>
            </div>
      <h1 style = "font-family: 'Courier New', Courier, monospace; font-size: 30px;"> Miami Grand Prix</h1>
               
                <P> Formula 1 Crypto.com Miami Grand Prix 2022 was a Formula One motor race that was held on May 8, 2022, at the Miami International Autodrome in Miami Gardens, Florida, United States. It was the first edition of the Miami Grand Prix and the fifth round of the 2022 Formula One World Championship.
 &nbsp;  </P>  
 ...
 &nbsp; 
         ...
         <hr>
          <div style="display:inline-block;vertical-align:top;">
            <img  src="https://www.formula1.com/content/dam/fom-website/2018-redesign-assets/Circuit%20maps%2016x9/Miami_Circuit.png.transform/9col/image.png" width="800" height="500"/> 
        </div>
            <div style="display:inline-block;">
        <div class="para">
         <h1 style = "font-family: 'Courier New', Courier, monospace; font-size: 30px;"> Miami Grand Prix Circuit</h1>
            <ul class = "no-bullets"> 
             <li Style = "text-align:left"><h2>Miami International Autodrome</h2></li>
             <P></P>
             <li Style = "text-align:left">Purpose-built temporary circuit</li>
             <P></P>
             <li Style = "text-align:left">Course Length: 5.412 km (3.363 miles)</li>
             <P></P>
             <li Style = "text-align:left">Distance:57 laps, 308.326 km (191.585 miles) \</li>
             <P></P>
             <li Style = "text-align:left">Weather: Warm, partly cloudy  </li>
             <P></P>
             <li Style = "text-align:left">Coordinates: 25°57′29″N 80°14′20″W]</li>
             <P></P>            
             <li Style = "text-align:left">Opened: 6 May 2022</li>
...
<hr>
  ...
  <div class="container">
    <div class="image">
          <img src="https://s3-eu-west-1.amazonaws.com/racingnews-v2-prod/_1125x633_crop_center-center_85_none/FSQocpIXMAE3A28.jpg?v=1652039057"
  width="700" height="400"/>
          </div>
   
          <div class = "text"> <h1 style = "font-family: 'Courier New', Courier, monospace; font-size: 30px;">Miami Grand Prix Race  </h1>
             
              <P>The race started at 15:30 EDT (UTC−4) on May 8 and lasted 57 laps.</p>
               <P> The race was won by Max Verstappen, ahead of championship leader and pole-sitter Charles Leclerc in second and his teammate Carlos Sainz Jr. in third.</p>
                    <P> In the first corner at the start, Verstappen overtook Sainz for second place and closed in on Leclerc, whom he passed for the lead on lap 9</P> 
                    <P>  Verstappen was pressured by Leclerc but defended his position to take the win          </P>
                 <P> Max Verstappen had the fastest lap at time: 1:31.361 on lap 54</P>
                 &nbsp; 
 ...
 &nbsp; 
   ...
   <div class="center">
   <img src="https://www.gannett-cdn.com/presto/2022/05/08/NPPP/7167c573-4840-4979-8593-530593e33c6f-050822_F1_Miami1899.JPG" width="700" height="400"/><h1 style = "text-align: center;font-family: 'Courier New', Courier, monospace; font-size: 30px;">  2022 MIAMI GRAND PRIX PODIUM</h1>
</div>
&nbsp;
&nbsp;
&nbsp;
 ...
 <h1 style = "text-align: center;font-family: 'Courier New', Courier, monospace; font-size: 30px;"> RACE RESULTS</h1>
   ...
   <table>
    ...
    <tr>
        <td>1</td>
        <td>1</td>
        <td><img src ="https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Flag_of_the_Netherlands.svg/1200px-Flag_of_the_Netherlands.svg.png" height = "15" width=" 25">Max Verstappen</td>
