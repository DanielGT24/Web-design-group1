...
<body>
 ...
 <div class="row">
      <div class="column">
        <img style ="float: left;"src="https://www.formula1.com/content/fom-website/en/teams/Mercedes/_jcr_content/logo.img.jpg/1582638425211.jpg"width="550" height="300" class="image" style="width:100%" >
        <div style="display:inline-block;">
            <div class="para">
             <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">Mercedes</h1>
                <ul class = "no-bullets"> 
                 <li Style = "text-align:left; font-size: 25px;"><b>Full Team Racing: </b>Mercedes-AMG Petronas F1 Team</li>
                 <P></P>
                 <li Style = "text-align:left; font-size: 25px;"><B>Constructor Rank:</B>3</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Based In: </b>United Kingdom</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Races Entered:</b>257</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Drivers:</b> George Russell & Lewis Hamilton</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Wins:</b>124</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Constructors' Championships won:</b>8</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Driver's Championships:</b> 9</li>
     ...
     <hr>
      <div class="column">
        ...
        <img style ="float: right;"src="https://www.formula1.com/content/dam/fom-website/teams/2022/mercedes.png.transform/4col/image.png"width="550" height="150" style="width:100%">
        <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/george-russell/_jcr_content/image.img.640.medium.jpg/1646750994602.jpg"  width="350" height="400" style="width:100%">
          </div>
          <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/lewis-hamilton/_jcr_content/image.img.640.medium.jpg/1647334259839.jpg" width="350" height="400" style="width:100%">
          </div>
    </div>
    </div>
