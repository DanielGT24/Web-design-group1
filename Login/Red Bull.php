...
<meta charset="utf-8">
<link rel="stylesheet" href="Constructors info.css">
...
<body>
 ...
 <div class="row">
      <div class="column">
        <img style ="float: left;"src="https://www.formula1.com/content/fom-website/en/teams/Red-Bull-Racing/_jcr_content/logo.img.jpg/1645620474276.jpg"width="550" height="300" class="image" style="width:100%" >
        <div style="display:inline-block;">
            <div class="para">
             <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">Red Bull Racing</h1>
                <ul class = "no-bullets"> 
                 <li Style = "text-align:left; font-size: 25px;"><b>Full Team Racing: </b>Oracle Red Bull Racing</li>
                 <P></P>
                 <li Style = "text-align:left; font-size: 25px;"><B>Constructor Rank:</B>1</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Based In: </b>United Kingdom</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Races Entered:</b>334</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Drivers:</b>Max Verstappen & Sergio Perez</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Wins:</b> 81</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Constructors' Championships won:</b>4</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Driver's Championships:</b> 5</li>
     ...
     <hr>
      <div class="column">
        <img style ="float: right;"src="https://img.alicdn.com/imgextra/i4/6000000007334/O1CN01WyCPf92431FrjFkeX_!!6000000007334-0-m_tb_svideo_preimg.jpg"  width="550" height="150" style="width:100%">

        <img style ="float: right;"src="https://www.formula1.com/content/dam/fom-website/teams/2022/red-bull-racing.png.transform/4col/image.png"  width="550" height="150" style="width:100%">
        <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/max-verstappen/_jcr_content/image.img.1920.medium.jpg/1646819045507.jpg"  width="350" height="400" style="width:100%">
          </div>
          <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/sergio-perez/_jcr_content/image.img.640.medium.jpg/1646819228700.jpg"  width="350" height="400" style="width:100%">
          </div>
    </div>
    </div>
