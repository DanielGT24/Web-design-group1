...
<body>
 ...
 <div class="row">
      <div class="column">
        <img style ="float: left;"src="https://www.formula1.com/content/fom-website/en/teams/Ferrari/_jcr_content/logo.img.jpg/1521797474166.jpg"width="550" height="300" class="image" style="width:100%" >
        <div style="display:inline-block;">
            <div class="para">
             <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">Ferrari</h1>
                <ul class = "no-bullets"> 
                 <li Style = "text-align:left; font-size: 25px;"><b>Full Team Racing: </b>Scuderia Ferrari</li>
                 <P></P>
                 <li Style = "text-align:left; font-size: 25px;"><B>Constructor Rank:</B>2</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Based In: </b>Italy</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Races Entered:</b>1041</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Drivers:</b>Max Verstappen & Sergio Perez</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Wins:</b> 240</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Constructors' Championships won:</b>16</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Driver's Championships:</b> 25</li>
    ...
    <p> &nbsp; </p>
     ...
     <hr>
      <div class="column">
        ...
        <img style ="float: right;"src="https://www.formula1.com/content/dam/fom-website/teams/2022/ferrari.png.transform/4col/image.png" width="550" height="150" style="width:100%">
        <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/carlos-sainz/_jcr_content/image.img.640.medium.jpg/1646818866749.jpg"  width="350" height="400" style="width:100%">
          </div>
          <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/charles-leclerc/_jcr_content/image.img.640.medium.jpg/1646818893219.jpg"  width="350" height="400" style="width:100%">
          </div>
    </div>
    </div>
