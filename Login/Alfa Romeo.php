...
<body>
 ...
 <div class="row">
      <div class="column">
        <img style ="float: left;"src="https://www.formula1.com/content/fom-website/en/teams/Alfa-Romeo-Racing/_jcr_content/logo.img.png/1643019381208.png"width="550" height="300" class="image" style="width:100%" >
        <div style="display:inline-block;">
            <div class="para">
             <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">Alfa Romeo</h1>
                <ul class = "no-bullets"> 
                 <li Style = "text-align:left; font-size: 25px;"><b>Full Team Racing: </b>Alfa Romeo F1 Team ORLEN</li>
                 <P></P>
                 <li Style = "text-align:left; font-size: 25px;"><B>Constructor Rank:</B>6</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Based In: </b>Switzerland</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Races Entered:</b>178</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Drivers:</b> Valterri Bottas & Zhou Guanyu </li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Wins:</b>10</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Constructors' Championships won:</b>N/A</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Driver's Championships:</b>N/A</li>
    ...
    <p> &nbsp; </p>
     ...
     <p> &nbsp; </p>
      <div class="column">
        ...
        <img style ="float: right;"src="https://www.formula1.com/content/dam/fom-website/teams/2022/alpine.png.transform/4col/image.png"  width="550" height="150" style="width:100%">
        <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/valtteri-bottas/_jcr_content/image.img.640.medium.jpg/1646819266274.jpg"width="350" height="400" style="width:100%">
          </div>
          <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/guanyu-zhou/_jcr_content/image.img.640.medium.jpg/1646818979975.jpg" width="350" height="400" style="width:100%">
          </div>
    </div>
    </div>
