...
<body>
 ...
 <div class="row">
      <div class="column">
        <img style ="float: left;"src="https://www.formula1.com/content/fom-website/en/teams/McLaren/_jcr_content/logo.img.jpg/1644831223911.jpg"width="550" height="300" class="image" style="width:100%" >
        <div style="display:inline-block;">
            <div class="para">
             <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">McLaren</h1>
                <ul class = "no-bullets"> 
                 <li Style = "text-align:left; font-size: 25px;"><b>Full Team Racing: </b>McLaren F1 Team </li>
                 <P></P>
                 <li Style = "text-align:left; font-size: 25px;"><B>Constructor Rank:</B>4</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Based In: </b>United Kingdom</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Races Entered:</b>914</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Drivers:</b> Daniel Ricardo & Lando Norris</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>Wins:</b>183</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Constructors' Championships won:</b>8</li>
                 <P></P>
                 <li Style = "text-align:left;font-size: 25px;"><b>World Driver's Championships:</b>12</li>
    ...
    <p> &nbsp; </p>
     ...
     <hr>
      <div class="column">
        ...
        <img style ="float: right;"src="https://www.formula1.com/content/dam/fom-website/teams/2022/mclaren.png.transform/4col/image.png"  width="550" height="150" style="width:100%">
        <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/daniel-ricciardo/_jcr_content/image.img.640.medium.jpg/1646818924510.jpg" width="350" height="400" style="width:100%">
          </div>
          <div class="column">
            <img style ="float: right;"src="https://www.formula1.com/content/fom-website/en/drivers/lando-norris/_jcr_content/image.img.640.medium.jpg/1646819013197.jpg"  width="350" height="400" style="width:100%">
          </div>
    </div>
    </div>
