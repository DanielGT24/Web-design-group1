...
<div style="display:inline-block;vertical-align:top;">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Flag_of_Monaco_%28bordered%29.svg/960px-Flag_of_Monaco_%28bordered%29.svg.png" 
   width="105" height="80"/> 
</div>
    <div style="display:inline-block;">
<div class="header">
  <h1 style = "text-align: left; font-size: 30px;">CHARLES LECLERC</h1>
         ...
         <hr>
          <div style="display:inline-block;vertical-align:top;">
            <img  src="https://www.formula1.com/content/fom-website/en/drivers/charles-leclerc/_jcr_content/image.img.640.medium.jpg/1646818893219.jpg" alt="img"
             width="550" height="600"/>
        </div>
            <div style="display:inline-block;">
        <div class="para">
         <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">Charles Leclerc</h1>
            <ul class = "no-bullets"> 
             <li Style = "text-align:left; font-size: 25px;"><b>Team: </b>Ferrari</li>
             <P></P>
             <li Style = "text-align:left; font-size: 25px;"><B>Driver Rank:</B>3</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Country:</b> Monaco</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Date of Birth:</b> 16/10/1997</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Place of Birth:</b>Monte Carlo, Monaco </li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Podiums:</b> 17</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Grand Prix Entered:</b> 90</li>
             <P></P>
