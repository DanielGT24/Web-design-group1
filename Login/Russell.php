...
<div style="display:inline-block;vertical-align:top;">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Flag_of_the_United_Kingdom_%282-3%29.svg/1200px-Flag_of_the_United_Kingdom_%282-3%29.svg.png" 
   width="105" height="80"/> 
</div>
    <div style="display:inline-block;">
<div class="header">
    
              <h1 style = "text-align:left; 'Courier New', Courier, monospace; font-size: 30px;">GEORGE RUSSELL</h1>
</div>
</div>
      
         <hr>
          <div style="display:inline-block;vertical-align:top;">
            <img  src="https://www.formula1.com/content/fom-website/en/drivers/george-russell/_jcr_content/image.img.640.medium.jpg/1646750994602.jpg" 
             width="550" height="600"/>
        </div>
            <div style="display:inline-block;">
        <div class="para">
                <div style="display:inline-block;">
          <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">George Russell</h1>
          
            <ul class = "no-bullets"> 
             <li Style = "text-align:left; font-size: 25px;"><b>Team: </b>Mercedes</li>
             <P></P>
             <li Style = "text-align:left; font-size: 25px;"><B>Driver Rank:</B>4</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Country:</b> United Kingdom</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Date of Birth:</b> 15/02/1998</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Place of Birth:</b>King's Lynn, England </li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Podiums:</b> 4</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Grand Prix Entered:</b> 69</li>
             <P></P>
