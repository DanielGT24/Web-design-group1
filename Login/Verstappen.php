...
<div style="display:inline-block;vertical-align:top;">
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Flag_of_the_Netherlands.svg/1200px-Flag_of_the_Netherlands.svg.png"  width="105" height="80"/> 
</div>
    <div style="display:inline-block;">
<div class="header">
  <h1 style = " font-size: 30px;">MAX VERSTAPPEN</h1>
         ...
         <hr>
          <div style="display:inline-block;vertical-align:top;">
            <img  src="https://www.formula1.com/content/fom-website/en/drivers/max-verstappen/_jcr_content/image.img.640.medium.jpg/1646819045507.jpg"  width="550" height="600"/>
        </div>
            <div style="display:inline-block;">
        <div class="para">
         <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;"> Driver: Max Verstappen</h1>
            <ul class = "no-bullets"> 
             <li Style = "text-align:left; font-size: 25px;"><b>Team: </b>Red Bull Racing</li>
             <P></P>
             <li Style = "text-align:left; font-size: 25px;"><B>Driver Rank:</B>1</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Country:</b> Netherlands</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Date of Birth:</b> 30/09/1997</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Place of Birth:</b> Hasselt, Belgium</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Podiums:</b> 67</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Grand Prix Entered:</b> 150</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>World Championships:</b> 1</li>
