...
<div style="display:inline-block;vertical-align:top;">
    <img src="https://cdn.britannica.com/73/2573-004-29818847/Flag-Mexico.jpg" alt="img"
   width="105" height="80"/> 
</div>
    <div style="display:inline-block;">
<div class="header">
  <h1 style = " font-size: 30px;">SERGIO PEREZ</h1>
         ...
         <hr>
          <div style="display:inline-block;vertical-align:top;">
            <img  src="https://www.formula1.com/content/fom-website/en/drivers/sergio-perez/_jcr_content/image.img.640.medium.jpg/1646819228700.jpg"
          width="550" height="600"/>
        </div>
            <div style="display:inline-block;">
        <div class="para">
         <h1 style = "font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 30px;">Sergio Perez</h1>
            <ul class = "no-bullets"> 
             <li Style = "text-align:left; font-size: 25px;"><b>Team: </b>Red Bull Racing</li>
             <P></P>
             <li Style = "text-align:left; font-size: 25px;"><B>Driver Rank:</B>2</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Country:</b> Mexico</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Date of Birth:</b> 26/01/1990</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Place of Birth:</b>Guadalajara, Mexico </li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Podiums:</b> 20</li>
             <P></P>
             <li Style = "text-align:left;font-size: 25px;"><b>Grand Prix Entered:</b> 223</li>
             <P></P>
