...
<body>
    ...
    <section>
      ...
      <article>
        ...
        <h1 style = "text-align: center; font-size: 40px;">CONSTRUCTORS</h1>
...
<div class="row">
    <div class="column">
      <div class="container">
        <a href="Red Bull.php"><img src="https://www.formula1.com/content/fom-website/en/teams/Red-Bull-Racing/_jcr_content/logo.img.jpg/1645620474276.jpg" class="image" width="100" height="250" style="width:100%">
          <div class="overlay"><h2 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Red Bull Racing</h2></div></a> </div>
    </div>
     <div class="column">
      <div class="container">
        <a href="Ferrari.php"><img src="https://www.formula1.com/content/fom-website/en/teams/Ferrari/_jcr_content/logo.img.jpg/1521797474166.jpg" class="image" width="100" height="250" style="width:100%">
      <div class="overlay"><h2 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Ferrari</h2></div></a>
    </div>
    </div>
    <div class="column">
        <div class="container">
          <a href="Mercedes.php"> <img src="https://www.formula1.com/content/fom-website/en/teams/Mercedes/_jcr_content/logo.img.jpg/1582638425211.jpg" class="image" width="100" height="250" style="width:100%">
        <div class="overlay"><h2 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Mercedes</h2> </div></a>
      </div>
      </div>
  </div>
...
<div class="column">
  <div class="container">
    <a href="Mc Laren.php"> <img src="https://www.formula1.com/content/fom-website/en/teams/McLaren/_jcr_content/logo.img.jpg/1644831223911.jpg" class="image" width="100" height="250" style="width:100%">
  <div class="overlay"><h2 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">McLaren</h2></div> </a>
</div>
</div>
 <div class="column">
  <div class="container">
    <a href="Alpine.php"> <img src="https://www.formula1.com/content/fom-website/en/teams/Alpine/_jcr_content/logo.img.jpg/1645620884650.jpg" class="image" width="100" height="250" style="width:100%">
  <div class="overlay"><h2 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Alpine</h2></div> </a>
</div>
</div>
<div class="column">
    <div class="container">
      <a href="Alfa Romeo.php"><img src="https://www.formula1.com/content/fom-website/en/teams/Alfa-Romeo-Racing/_jcr_content/logo.img.png/1643019381208.png" class="image" width="100" height="250" style="width:100%">
    <div class="overlay"><h2 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Alfa Romeo</h2></div> </a>
  </div>
  </div>
</div>
