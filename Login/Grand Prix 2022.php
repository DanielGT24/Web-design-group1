...
<meta charset="utf-8">
<link rel="stylesheet" href="Grand Prix.css">
    ...
    <section>
      ...
      <article>
        ...
        <div class="row">
            <div class="column">
              <div class="container">
                <a href="Bahrain.php"> <img src="Bahrain.png" class="image" width="100" height="250" style="width:100%"></a>
              <div class="overlay">Formula 1 Gulf Air Bahrain</div>
            </div>
            </div>
             <div class="column">
              <div class="container">
                <a href="Saudi Arabia.php"><img src="Arabia.png" class="image" width="100" height="250" style="width:100%">
              <div class="overlay">Formula 1 STC Saudi Arabia</div></a>
            </div>
            </div>
            <div class="column">
                <div class="container">
                  <a href="Australia.php"> <img src="Australia.png" class="image" width="100" height="250" style="width:100%">
                <div class="overlay">Formula 1 Heineken Australian </div></a>
              </div>
              </div>
          </div>
      ...
      <div class="row">
        <div class="column">
          <div class="container">
            <a href="Italy.php"> <img src="italy.png" class="image" width="100" height="250" style="width:100%">
          <div class="overlay">Formula 1 Rolex Gran Premio Del Made in Italy E Dell'emilia Romagna </div> </a>
        </div>
        </div>
         <div class="column">
          <div class="container">
            <a href="Miami.php"> <img src="Miami.png"class="image" width="100" height="250" style="width:100%">
          <div class="overlay">Formula 1 Crypto.com Miami United States</div> </a>
        </div>
        </div>
        <div class="column">
            <div class="container">
              <a href="Spain.php"><img src="Spain.png" class="image" width="100" height="250" style="width:100%">
            <div class="overlay">Formula 1 Pirelli Gran Premio de Espana </div> </a>
          </div>
          </div>
      </div>
